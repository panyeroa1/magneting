...
export const LogoIcon = (props: React.ImgHTMLAttributes<HTMLImageElement>) => (
    <img src="https://aiteksoftware.site/magnetar/logo.png" alt="Manetar Logo" width="140" height="32" {...props} />
);
...
export const BookmarkIconFilled = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"></path></svg>
);

export const NAV_ITEMS = [
    { href: '#home', label: 'Home', icon: <HomeIcon className="w-6 h-6" /> },
    { href: '#trainings', label: 'Trainings', icon: <BookOpenIcon className="w-6 h-6" /> },
    { href: '#videos', label: 'Videos', icon: <VideoIcon className="w-6 h-6" /> },
